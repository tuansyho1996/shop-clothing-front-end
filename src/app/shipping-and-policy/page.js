    ...
    return (
        <div className="container mx-auto px-4 py-8 min-h-[50vh]">
            ...
            <section className="mb-8">
                ...
                <p>If your address is correct and your package is lost in the mail, please contact USPS. If USPS is unable to locate the package, get in touch with our Support Team at <a href="mailto:support@carnobon.com" className="text-blue-600 underline">support@carnobon.com</a> within 4 weeks of the expected delivery date. Let us know your order number and we'll take care of you!</p>
            ...
            <section className="mb-8">
                ...
                <p className="mt-4">If you’ve done all of this and you still have not received your refund yet, please contact us at <a href="mailto:support@carnobon.com" className="text-blue-600 underline">support@carnobon.com</a>.</p>
            </section>
        </div>
    );
};
