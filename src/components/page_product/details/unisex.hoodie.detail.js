const UnisexDetail = () => {
    ...
    return (
        <div className="product-detail">
            <p className="mt-5">100% pure cotton, natural fiber, environmentally friendly material, perfect for eco-conscious shoppers. Strong heat retention, keep you warm at cold nights. Large side pockets are perfect for carrying your phone, keys or wallet.</p>
