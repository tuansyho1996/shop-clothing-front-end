            ...
            <ul className="flex gap-2 cursor-pointer flex-wrap justify-center mt-4">
              <li title='Ethereum'>
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="none" viewBox="0 0 24 24" >
                  ...
                  <path fill="#202699" fill-rule="evenodd" d="m12 15.429-5.625-3.263L12 3l5.625 9.166zM6.749 11.9l5.16-8.41v6.115zm-.077.23 5.238-2.327v5.364zm5.418-2.327v5.364l5.233-3.038zm0-.198 5.16 2.295-5.16-8.41z" clip-rule="evenodd" />
                  <path fill="#202699" fill-rule="evenodd" d="M12 16.406 6.375 13.21 12 21l5.625-7.79zm-4.995-2.633 4.905 2.79v4.005zm5.085 2.79v4.005l4.905-6.795z" clip-rule="evenodd" />
                </svg>
              </li>
              <li title='Arbitrum'>
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="none" viewBox="0 0 24 24">
            ...
            <ul className="flex gap-4 flex-wrap justify-center mt-5">
              <li>
                <a href={`${faceboolk?.global_value}`} target="_blank">
                  <svg className='hover:scale-125' xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#1877F2" class="bi bi-facebook" viewBox="0 0 16 16">
              ...
              <li>
                <a href={`${twitter?.global_value}`} target="_blank">
                  <svg className='hover:scale-125' width="30" height="30" fill="black" class="bi bi-twitter-x" viewBox="0 0 16 16">
              ...
              <li>
                <a href={`${instagram?.global_value}`} target="_blank">
                  <svg className='hover:scale-125' xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 16 16">
                    <defs>
